...
@patch(
        f'{RECORDS_PACKAGE}.appointment_record.utc_timestamp_now',
...
@patch(
        f'{RECORDS_PACKAGE}.details_record.utc_timestamp_now',
        mock_utc_timestamp_now
)
@patch(f'{PUT_RECORDS_PACKAGE}.get_pet_table_resource')
...
@patch(
        f'{RECORDS_PACKAGE}.illness_record.utc_timestamp_now',
        mock_utc_timestamp_now
)
@patch(f'{PUT_RECORDS_PACKAGE}.get_pet_table_resource')
...
@patch(
        f'{RECORDS_PACKAGE}.medication_record.utc_timestamp_now',
        mock_utc_timestamp_now
)
@patch(f'{PUT_RECORDS_PACKAGE}.get_pet_table_resource')
def tests_put_medication_record(get_pet_table_resource: Mock):
    ...
    expected_item = {
        'name': 'me',
        'sort_key': f'medication#good kind#{mock_utc_timestamp_now()}',
...
@patch(
        f'{RECORDS_PACKAGE}.observation_record.utc_timestamp_now',
        mock_utc_timestamp_now
)
@patch(f'{PUT_RECORDS_PACKAGE}.get_pet_table_resource')
